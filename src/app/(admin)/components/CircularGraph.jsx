...
const ProfileWithCharts = ({ studentData, handleEditClick }) => {
    ...
    return (
        <div className="w-full flex justify-center flex-col items-center gap-10 py-8">
            {/* Hackathon Progress - Trophy Style */}
            <div className="w-[300px] h-[300px] flex flex-col items-center justify-center">
                <h4 className="text-white font-semibold text-center text-2xl mb-4">Hackathons</h4>
                ...
                <p className="text-center text-white font-medium mt-2">5 Completed, 2 Remaining</p>
            </div>

            {/* Internship Progress - Medal Style */}
            <div className="w-[300px] h-[300px] flex flex-col items-center justify-center">
                <h4 className="text-white font-semibold text-center text-2xl mb-4">Internships</h4>
                <div className="relative w-[220px] h-[220px] flex items-center justify-center">
                    <Doughnut 
                        data={internshipData}
                        options={{
                ...
                <p className="text-center text-white font-medium mt-2">3 Completed, 1 Remaining</p>
            </div>
        </div>
    );
};
