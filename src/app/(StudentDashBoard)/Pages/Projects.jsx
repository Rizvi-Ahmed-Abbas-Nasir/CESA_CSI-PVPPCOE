...
function CreateEvent() {
  ...
  const handleSubmit = async (e) => {
    ...
    const validCategories = ['Internship', 'Sponsored Project ', 'Personal Project']; // List of valid categories
  ...
  <h2 className="text-2xl mb-6 text-center">Add Project/Internship</h2>
  ...
  <form onSubmit={handleSubmit} className="space-y-6 w-full flex flex-col">
    ...
    <div className="flex items-center w-full">
      <label className="font-semibold mb-1 w-1/4">Name:</label>
      <input
        type="text"
        name="eventName"
    ...
    {/* Speaker Name */}
    <div className="flex items-center w-full">
      <label className="font-semibold mb-1 w-1/4">Associate Name:</label>
      <input
        type="text"
        name="collegename"
    ...
    {/* Date of Event */}
    <div className="flex items-center w-full">
      <label className="font-semibold mb-1 w-1/4">Start Date:</label>
      <input
        type="date"
        name="date"
        value={formData.date}
    ...
    {/* Event Deadline */}
    <div className="flex items-center w-full">
      <label className="font-semibold mb-1 w-1/4">End Date:</label>
      <input
        type="datetime-local"
        name="eventDate"
    ...
    {/* Event Time */}
    <div className="flex items-center w-full">
      <label className="font-semibold mb-1 w-1/4">Working Timing:</label>
      <input
        type="time"
        name="time"
        value={formData.time}
    ...
    {/* Event Description */}
    <div className="flex items-center w-full">
      <label className="font-semibold mb-1 w-1/4">Description:</label>
      <textarea
    ...
    {/* Is the event Online? */}
    <div className="flex items-center w-full">
          <label className="font-semibold mb-1 w-1/4">Paid?</label>
    ...
    {formData.money && (
      <div className="flex items-center w-full">
        <label className="font-semibold mb-1 w-1/4">Amount:</label>
        <input
          type="text"
          name="eventLink"
    ...
    {/* Event Status */}
    <div className="flex items-center w-full">
      <label className="font-semibold mb-1 w-1/4"> Status:</label>
      <select
        name="eventStatus"
      ...
      >
        ...
        <option value="Ongoing">Semi-Completed </option>
